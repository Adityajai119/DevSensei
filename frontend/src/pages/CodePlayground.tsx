        ...
        <div className="mb-6">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-900 border border-gray-800 rounded-lg focus:outline-none focus:border-white"
            />
            <button
              onClick={generateCode}
              disabled={loading || !prompt.trim()}
              className="px-6 py-2 bg-white text-black hover:bg-gray-200 rounded-lg flex items-center gap-2 transition-colors disabled:opacity-50"
            >
              <Code size={20} />
              Generate
            </button>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button
              onClick={executeCode}
              disabled={loading}
              className="px-4 py-2 bg-white text-black hover:bg-gray-200 rounded-lg flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-white text-black hover:bg-gray-200 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
            >
              <Bug size={20} />
              Debug
            </button>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-24 px-3 py-2 bg-gray-900 border border-gray-800 rounded-lg focus:outline-none focus:border-white font-mono text-sm"
            />
          </div>
        </div>
        ...
        <div className="space-y-4 mt-8">
          ...
          {showExplanation && (
            ...
            >
              ...
              <div className="h-64 p-4 bg-gray-900 rounded-lg border border-gray-800 overflow-auto">
